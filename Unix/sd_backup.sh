...
then
	...
	zip -X $HOME/Downloads/$image_name.zip $HOME/Downloads/$image_name || error_exit "Unable to compress image"
	echo "Compression complete"
	# Delete the original image now it's compressed
	rm $HOME/Downloads/$image_name
fi
